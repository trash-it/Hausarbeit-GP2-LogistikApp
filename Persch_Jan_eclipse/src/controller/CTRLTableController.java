...
public class CTRLTableController {
    ...
    static TableColumn<MODELWare, String> tcartikel =
            new TableColumn<MODELWare, String>("Artikel");

    /** The TableColumn tcanzahl. */
    static TableColumn<MODELWare, Integer> tcanzahl =
            new TableColumn<MODELWare, Integer>("Anzahl");

    /** The TableColumn tcgewicht. */
    static TableColumn<MODELWare, Double> tcgewicht =
            new TableColumn<MODELWare, Double>("Gewicht");

    /** The TableColumn tcpalette. */
    static TableColumn<MODELWare, Boolean> tcpalette =
            new TableColumn<MODELWare, Boolean>("Auf Palette");
    ...
    public static void setTableContent(ObservableList<MODELWare> warenliste) {
        ...
        tcartikel.setCellFactory(TextFieldTableCell.<MODELWare>forTableColumn());
        tcanzahl.setCellFactory(TextFieldTableCell.<MODELWare, Integer>forTableColumn(
                new IntegerStringConverter()));
        tcgewicht.setCellFactory(TextFieldTableCell.<MODELWare, Double>forTableColumn(
                new DoubleStringConverter()));
        tcpalette.setCellFactory(TextFieldTableCell.<MODELWare, Boolean>forTableColumn(
